...
// Component to handle map initialization - same pattern as MapComponent
function MapController({ selectedDistrict }: { selectedDistrict: string }) {
  ...
  useEffect(() => {
    ...
    const coords = DISTRICT_COORDS[selectedDistrict] || { center: [7.8731, 80.7718], zoom: 8 };
...
// Component to handle marker placement - using useMapEvents like MapComponent
...
export default function CampLocationPicker({
  ...
  const districtCoords = DISTRICT_COORDS[selectedDistrict] || { 
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex justify-between items-center p-4 border-b">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold">Select Camp Location</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 bg-blue-50 border-b">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-700">
              Click anywhere on the map to place a marker. Drag to adjust.
            </span>
          </div>
        </div>
